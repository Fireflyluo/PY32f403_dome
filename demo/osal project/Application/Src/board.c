...
uart_instance_t log_uart_instance = UART_INSTANCE_2;
...
void board_init(void)
{
    ...
    // 串口初始化 中断模式
    uart_init(log_uart_instance, 115200, UART_MODE_DMA);
    // 启动DMA接收
    uart_dma_start_rx(log_uart_instance, UART_DMA_MODE_CIRCULAR);
