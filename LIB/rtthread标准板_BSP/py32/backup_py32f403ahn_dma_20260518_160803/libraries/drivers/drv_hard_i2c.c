...
static rt_err_t py32_i2c_init(struct py32_i2c *i2c_drv)
{
    ...
    struct py32_i2c_config *cfg = i2c_drv->config;
...
static rt_err_t py32_i2c_configure(struct rt_i2c_bus_device *bus)
{
    RT_ASSERT(RT_NULL != bus);
    struct py32_i2c *i2c_drv = rt_container_of(bus, struct py32_i2c, i2c_bus);

    return py32_i2c_init(i2c_drv);
}
/**
...
int RT_hw_i2c_bus_init(void)
{
    ...
    for (int i = 0; i < obj_num; i++)
    {
        ...
        py32_i2c_configure(&i2c_objs[i].i2c_bus);
