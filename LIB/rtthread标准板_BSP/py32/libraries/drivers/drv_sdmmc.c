...
/**
  ...
  * @retval PCLK2Freq
  */
static rt_uint32_t py32_sdio_clock_get(void)
{
...
{
#ifdef BSP_USING_SDIO1
    struct py32_sdio_des sdio_des1 = {0};
    ...
    sdio_des1.clk_get  = py32_sdio_clock_get;
...
#ifdef BSP_USING_SDIO2
    struct py32_sdio_des sdio_des2 = {0};
    ...
    sdio_des2.clk_get  = py32_sdio_clock_get;
