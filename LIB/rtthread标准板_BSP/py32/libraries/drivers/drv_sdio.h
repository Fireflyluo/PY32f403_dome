...
typedef rt_uint32_t (*sdio_clk_get)(struct py32_sdio *hw_sdio);

struct py32_sdio_des
{
...
struct py32_sdio_class
{
    struct py32_sdio_des *des;
    const struct py32_sdio_config *cfg;
...
extern void py32_mmcsd_change(void);
