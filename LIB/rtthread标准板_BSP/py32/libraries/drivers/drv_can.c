...
static const struct py32_baud_rate_tab can_baud_rate_tab[] =
{
...
static struct py32_can drv_can1 =
{
    .name = "can1",
...
static struct py32_can drv_can2 =
{
    "can2",
...
{
    struct py32_can *drv_can;
    rt_uint32_t baud_index;

    RT_ASSERT(can);
    RT_ASSERT(cfg);
    drv_can = (struct py32_can *)can->parent.user_data;
    RT_ASSERT(drv_can);
...
static int _can_sendmsg(struct rt_can_device *can, const void *buf, rt_uint32_t box_num)
{
    ...
    hcan = &((struct py32_can *) can->parent.user_data)->CanHandle;
