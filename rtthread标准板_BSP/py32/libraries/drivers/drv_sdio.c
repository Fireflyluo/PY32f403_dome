...
static struct py32_sdio_config sdio_config = SDIO_BUS_CONFIG;
static struct py32_sdio_class sdio_obj;
...
static rt_uint32_t py32_sdio_clk_get(struct py32_sdio *hw_sdio)
{
...
static void rthw_sdio_wait_completed(struct rthw_sdio *sdio)
{
    ...
    struct py32_sdio *hw_sdio = sdio->sdio_des.hw_sdio;
...
/**
  ...
  * @param  sdio_des  py32_sdio_des
  * @retval rt_mmcsd_host
  */
struct rt_mmcsd_host *sdio_host_create(struct py32_sdio_des *sdio_des)
{
    struct rt_mmcsd_host *host;
    ...
    rt_memcpy(&sdio->sdio_des, sdio_des, sizeof(struct py32_sdio_des));
    sdio->sdio_des.hw_sdio = (sdio_des->hw_sdio == RT_NULL ? (struct py32_sdio *)SDIO_BASE_ADDRESS : sdio_des->hw_sdio);
    sdio->sdio_des.clk_get = (sdio_des->clk_get == RT_NULL ? py32_sdio_clk_get : sdio_des->clk_get);
...
/**
  ...
  * @param  hw_sdio: py32_sdio
  * @retval PCLK2Freq
  */
static rt_uint32_t py32_sdio_clock_get(struct py32_sdio *hw_sdio)
{
...
int rt_hw_sdio_init(void)
{
    ...
    sdio_des.clk_get = py32_sdio_clock_get;
    sdio_des.hw_sdio = (struct py32_sdio *)SDCARD_INSTANCE;
