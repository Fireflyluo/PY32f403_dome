...
extern void py32_mipi_lcd_init(void);
extern void py32_mipi_lcd_config(rt_uint32_t pixel_format);
extern void py32_mipi_display_on(void);
extern void py32_mipi_display_off(void);
...
rt_err_t ltdc_init(void)
{
    ...
    py32_mipi_lcd_config(RTGRAPHIC_PIXEL_FORMAT_RGB565);
...
static rt_err_t py32_lcd_init(rt_device_t device)
{
...
static rt_err_t py32_lcd_control(rt_device_t device, int cmd, void *args)
{
    switch(cmd)
    {
    ...
    case RTGRAPHIC_CTRL_POWERON:
        py32_mipi_display_on();
        break;

    case RTGRAPHIC_CTRL_POWEROFF:
        py32_mipi_display_off();
        break;
...
rt_weak void py32_mipi_lcd_init(void)
{
    rt_kprintf("please Implementation function %s\n", __func__);
}

rt_weak void py32_mipi_lcd_config(rt_uint32_t pixel_format)
{
    rt_kprintf("please Implementation function %s\n", __func__);
}

rt_weak void py32_mipi_display_on(void)
{
    rt_kprintf("please Implementation function %s\n", __func__);
}

rt_weak void py32_mipi_display_off(void)
{
    rt_kprintf("please Implementation function %s\n", __func__);
}
