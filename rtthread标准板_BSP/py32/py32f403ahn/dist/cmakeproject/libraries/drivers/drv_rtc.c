...
static rt_err_t py32_rtc_get_timeval(struct timeval *tv)
{
...
static rt_err_t py32_rtc_init(void)
{
...
static rt_err_t py32_rtc_get_secs(time_t *sec)
{
    struct timeval tv;

    py32_rtc_get_timeval(&tv);
...
static rt_err_t py32_rtc_set_secs(time_t *sec)
{
...
static rt_err_t py32_rtc_get_alarm(struct rt_rtc_wkalarm *alarm)
{
#ifdef RT_USING_ALARM
...
static rt_err_t py32_rtc_set_alarm(struct rt_rtc_wkalarm *alarm)
{
#ifdef RT_USING_ALARM
...
static const struct rt_rtc_ops py32_rtc_ops =
{
    py32_rtc_init,
    py32_rtc_get_secs,
    py32_rtc_set_secs,
...
static int rt_hw_rtc_init(void)
{
    ...
    rtc_device.rtc_dev.ops = &py32_rtc_ops;
